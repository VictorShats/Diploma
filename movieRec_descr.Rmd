---
назва: "VikToFilm - Інформаційна система релевантності фільмів до потреб користувача"
автор: "Віктор Шатських"
дата: "Квітень, 2017"
вихідні дані: Веб-додаток
---
...
And there is a summary and a head of *ratings*:
